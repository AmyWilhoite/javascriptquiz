...
console.log(
  "Im trying to add a method to this constructor function that carries out the function of checking answer then loop through the question - my method may not be best. Im committed!"
);
...
function QuestionFactory() {
  ...
  questionEl.textContent = "Question: " + questionsList[currentIndex].question;
  answerEl1.textContent = questionsList[currentIndex].answers[0];
  answerEl2.textContent = questionsList[currentIndex].answers[1];
  answerEl3.textContent = questionsList[currentIndex].answers[2];
  answerEl4.textContent = questionsList[currentIndex].answers[3];
...
function checkAnswer() {
  console.log("button clicked", this.textContent, questionsList[currentIndex].correctAns);
  if (this.textContent === questionsList[currentIndex].correctAns) {
    storeScore += 5;
    ...
    feedbackEL.textContent =
      "INCORRECT" + "some function for time to lose 5 seconds";
    timerEl = secondsLeft - 5;
  }
  //move to next question
  currentIndex++;
  //call the question factory again
  QuestionFactory();
}
/*
